...
import Inventory_java_client.auth.Authentication;
import Inventory_java_client.auth.HttpBasicAuth;
import Inventory_java_client.auth.ApiKeyAuth;
import Inventory_java_client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://www.orkiv.com/i/api";
    ...
    public ApiClient() {
        ...
        authentications.put("AccountID", new ApiKeyAuth("header", "accountid"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://www.orkiv.com/i/api
